...
all_expected = setdiff(expected$barcode, c("ALL"))
all_index = subset(expected, barcode == "ALL")$index
expected = rbind(expected, data.frame(barcode=all_expected, index=all_index[1]))
expected = rbind(expected, data.frame(barcode=all_expected, index=all_index[2]))
expected = rbind(expected, data.frame(barcode=all_expected, index=all_index[3]))
expected = subset(expected, barcode != "ALL")
